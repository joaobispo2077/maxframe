...
3. **Packaging** — `electron-builder` copies optional **yt-dlp** from `buildResources/yt-dlp/` and optional **ffmpeg** from `buildResources/ffmpeg/` into app `resources/` (see each folder’s `README.txt`; binaries not committed).
